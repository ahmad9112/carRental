...
function CarDetails() {
  ...
  return car?(
    <div className='p-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
  ...
  <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
    {
      ["360 camera","Bluetooth","GPS","Heated Seats","Rear View Mirror"].map((item)=>(
        ...
        onSubmit={handleSubmit} className='shadow-lg h-max stick top-18 rounded-xl p-6 space-y-6 text-gray-500'>
...
<p className='text-center text-sm'>No credit card required to serve</p>
        </motion.form>
